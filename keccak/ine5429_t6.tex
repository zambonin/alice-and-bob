...
$A$, que é um vetor de elementos tridimensional em $GF(2)$, chamado de $A$.
$f$ é uma permutação iterativa, consistindo de uma sequência de rodadas $R$.
...
\item A etapa $\theta$ faz a soma \texttt{XOR} de uma elemento de $A$ e todos
